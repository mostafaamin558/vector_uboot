...
#ifndef _HIKOB_AM35_H_
#define _HIKOB_AM35_H_

const omap3_sysinfo sysinfo = {
	DDR_DISCRETE,
	"HIKOB var-am35xx Board",
	"NAND",
};
 ...
 *
 * A8/M3 Cross - Reboot
 * -	MUX_VAL(CP(HECC1_TXD),		(IEN  | PTU | EN  | M4))
 * +	MUX_VAL(CP(HECC1_TXD),		(IEN  | PTD | EN  | M4))
 */
#define MUX_HIKOB_AM35XX()						\
	/* SDRC */							\
